...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Fix: unwrap data.data (ApiResponse wraps the payload inside .data)
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #071f12, #0f3a2a)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(201,149,42,0.25)', padding: '2.5rem' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", color: '#fdf6e3', fontSize: '2rem', marginBottom: '0.35rem' }}>Create Account</h2>
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.82rem', marginBottom: '2rem' }}>Join the Sawai family today</p>
